...
KEYS: dict[str, list[str]] = {
    ...
    "trades_carry": ["as_of", "structure", "asset", "instrument"],
    ...
    "trend_state": ["as_of", "base"],
    "reading_conflict": ["as_of", "base"],
    "resistance_scorecard": ["base", "date", "side", "r_def", "horizon"],
    "trades_vol": ["as_of", "structure", "asset", "instrument"],
    "coinglass_oi_history": ["date", "base"],
    "coinglass_funding_history": ["date", "base"],
    "coinglass_liq_history": ["date", "base"],
...
TIME_COL: dict[str, str] = {
    ...
    "borrow_rates": "as_of",
    "exchange_fees": "date",
    "exchange_fundamentals": "as_of",
    "resistance_model": "as_of",
    "resistance_active": "as_of",
    "resistance_scorecard": "resolve_date",
    "trend_state": "as_of",
    "reading_conflict": "as_of",
    "trades_vol": "as_of",
    "coinglass_oi_history": "date",
    "coinglass_funding_history": "date",
    "coinglass_liq_history": "date",
