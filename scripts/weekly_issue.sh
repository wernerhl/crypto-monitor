...
- [ ] OPEN REVIEW ITEM (opened 2026-09-08, decide at the December 2026 quarterly review): Rule 4.3 premise. Evidence: methods page "Rule 4.3 by driver" (hit rate by complacency / post-shock / both / neither, with episode counts). Decision to be recorded in \`docs/changelog.md\`; no threshold change before then.
